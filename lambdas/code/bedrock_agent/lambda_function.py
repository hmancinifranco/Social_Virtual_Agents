...
class DynamoDBOperations:
    ...
    def query(self, key_name: str, keyvalue: str) -> Optional[Dict]:
        try:
            ...
            if response['Items']:
                ...
                logger.info(f"No items found for {key_name}={keyvalue}")
                return None
    ...
    def invoke_agent(self, session_id: str, prompt: str, 
        ...
        try:
            ...
            try:
                ...
                if whatsapp_data and whatsapp_data.get('message_history'):
                ...
                logger.info(f"No message history found: {str(e)}")
        ...
        if message_type == "text":
            ...
            try:
                ...
                try:
                    ...
                    self.db_ops.update_item(phone_number,message_history)
